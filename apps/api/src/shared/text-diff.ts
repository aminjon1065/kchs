...
/**
 * Сравнение текста по словам (08-documents.md §8, ADR-0085): алгоритм Майерса
 * O((N+M)·D) над словами и промежутками. Общие начало и конец отбрасываются
 * сразу — у соседних версий они почти всегда совпадают; если различий больше
 * `maxEdits`, середина показывается целиком как «удалено / добавлено».
 * Общий слой: сравнение нужно и версиям документа, и версиям страницы базы
 * знаний (ADR-0095), поэтому живёт здесь, а не в модуле.
 */
